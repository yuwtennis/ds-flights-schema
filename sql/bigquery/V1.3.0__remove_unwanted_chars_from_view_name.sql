DROP VIEW IF EXISTS dsongcp.flights;

-- VIEW reflecting ALL records
...
-- Threshold based VIEWs
CREATE OR REPLACE VIEW dsongcp.delayed_10_2015 AS
SELECT * FROM dsongcp.flights WHERE dep_delay >= 10;

CREATE OR REPLACE VIEW dsongcp.delayed_15_2015 AS
SELECT * FROM dsongcp.flights WHERE dep_delay >= 15;

CREATE OR REPLACE VIEW dsongcp.delayed_20_2015 AS
